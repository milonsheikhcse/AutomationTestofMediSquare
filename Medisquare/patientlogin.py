...
driver.get("https://medisquare.com.bd/login")

#implicity_must privide otherwise it not work
driver.implicitly_wait(10)
#phone num
driver.find_element(By.CSS_SELECTOR,"input[placeholder='Ex: 01XXXXXXXXX']").send_keys('01521473929')
#password
driver.find_element(By.CSS_SELECTOR,"input[placeholder='Password']").send_keys('01521473929')
#button click
